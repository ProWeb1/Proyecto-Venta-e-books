  ...
  <head>
    ...
    <script>
      $(document).ready(function() {
        //alert("isa");
        $.ajax({
        url: "Ebook/paginaFichaProducto.php?id=4",
        data: {
        zipcode: 97201
        },
        success: function( data ) {
        $( "#contenedor_fichaProducto" ).html( "<div>" + data + "</div>" );
        }
        });
      });
    </script>
    <script>
      $(document).ready(function() {
        //alert("isa");
        $.ajax({
        url: "Ebook/paginaFichaResena.php?id=4",
        data: {
        zipcode: 97201
        },
        success: function( data ) {
        $( "#contenedor_fichaResena" ).html( "<div>" + data + "</div>" );
        }
        });
      });
    </script>
  ...
  <body>
    <div id="CajaGrande">
      <nav class="navbar navbar-inverse" role="navigation">
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php" onclick="location.href='index.php'"> <img src= "images/logo/ebbbooks-logo.png"></a>
          </div>
          <!-- Navegación-->
          <?php
      ...
      <div id="aboutMore" class="pagina">
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <div id="contenedor_fichaProducto">
            </div>
            <div id="contenedor_fichaResena">
            </div>
          </div><!-- Final Columna -->		  
        </div><!-- Final Fila -->
      </div>
