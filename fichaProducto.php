...
<html lang="es">
    ...
    <nav class="navbar navbar-inverse" role="navigation">
        ...
        <!-- Display Movil -->
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="" onclick="location.href='index.php'"> <img src= "images/logo/ebbbooks-logo.png"></a>
          </div>
 ...
 <div class="row">
   ...
   <div id="contenedor_fichaProducto">  </div>


    <div id="contenedor_fichaResena"> </div>
