                    ...
                    <ul class="catalogo-galeria" >
                        <li class="col-lg-2 col-md-2 col-sm-2" >
                                <div class="catalogo-galeria-imagen">
                                    <img src="images/portadas/14.jpg" class="img-responsive" alt="imagen1"/>
                                    <a href="fantasia.php">
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2" >
                                <div class="catalogo-galeria-imagen">
                                    <img src="images/portadas/20.jpg" class="img-responsive" alt="imagen2"/>
                                    <div class="catalogo-overlay">
                                        <h5>Fracture Me</h5>
                                        <hr/>
                                        <h4>Juvenil</h4>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2" >
                                <div class="catalogo-galeria-imagen">
                                    <img src="images/portadas/25.jpg" class="img-responsive" alt="imagen3"/>
                                    <a href="ficcion.php">
                                    <div class="catalogo-overlay">
                                        <h5>The left hand of God</h5>
                                        <hr/>
                                        <h4>Ficción</h4>
                                    </div>
                                </div>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2 " >
                                <div class="catalogo-galeria-imagen">
                                    <img src="images/portadas/50.jpg" class="img-responsive" alt="imagen4"/>
                                    <div class="catalogo-overlay">
                                        <h5>One</h5>
                                        <hr/>
                                        <h4>Aventura</h4>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2" >
                                <div class="catalogo-galeria-imagen">
                                    <img src="images/portadas/53.jpg" class="img-responsive" alt="imagen5"/>
                                    <div class="catalogo-overlay">
                                        <h5>Mastal Danger</h5>
                                        <hr/>
                                        <h4>Terror</h4>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2 " >
                                <div class="catalogo-galeria-imagen">
                                    <img src="images/portadas/49.jpg" class="img-responsive" alt="imagen6"/>
                                    <div class="catalogo-overlay">
                                        <h5>Incarnation</h5>
                                        <hr/>
                                        <h4>Histórico</h4>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2" >
                                <div class="catalogo-galeria-imagen">
                                    <img src="images/portadas/39.jpg" class="img-responsive" alt="imagen7"/>
                                    <div class="catalogo-overlay">
                                        <h5>The SpiritGlass Charade</h5>
                                        <hr/>
                                        <h4>Suspenso</h4>
                                    </div>
                                </div>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2 gallery gallery-creative" >
                                <div class="catalogo-galeria-imagen">
                                    <img src="images/portadas/54.jpg" class="img-responsive" alt="imagen8"/>
                                    <div class="catalogo-overlay">
                                        <h5>Archon</h5>
                                        <hr/>
                                        <h4>Paranormal</h4>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2" >
                                <div class="catalogo-galeria-imagen">
                                    <img src="images/portadas/52.jpg" class="img-responsive" alt="imagen9" />
                                    <div class="catalogo-overlay">
                                        <h5>Moonlight & Ashes</h5>
                                        <hr/>
                                        <h4>Romance</h4>
                                    </div>
                                </div>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2" >
                                <div class="catalogo-galeria-imagen">
                                    <img src="images/portadas/21.jpg" class="img-responsive" alt="imagen10"/>
                                    <div class="catalogo-overlay">
                                        <h5>The Goldfrinch</h5>
                                        <hr/>
                                        <h4>Novela Negra</h4>
                                    </div>
                                </div>
