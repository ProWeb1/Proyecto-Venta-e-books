...
CREATE TABLE `tarjeta_credito` (
  ...
  PRIMARY KEY (`codigo`),
  KEY `fk_tarjeta_usuario_idx` (`fk_usuario`),
  CONSTRAINT `fk_tarjeta_credito_usuario` FOREIGN KEY (`fk_usuario`) REFERENCES `usuario` (`codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
