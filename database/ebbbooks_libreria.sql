...
CREATE TABLE `libreria` (
  ...
  PRIMARY KEY (`numero`),
  KEY `fk_libreria_perfil_idx` (`fk_perfil`),
  CONSTRAINT `fk_libreria_perfil` FOREIGN KEY (`fk_perfil`) REFERENCES `perfil` (`codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
