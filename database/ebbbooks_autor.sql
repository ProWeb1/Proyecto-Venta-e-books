...
CREATE TABLE `autor` (
  ...
  PRIMARY KEY (`codigo`),
  KEY `fk_autor_persona_idx` (`fk_persona`),
  CONSTRAINT `fk_autor_persona` FOREIGN KEY (`fk_persona`) REFERENCES `persona` (`codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION
